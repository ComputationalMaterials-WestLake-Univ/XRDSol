...
from xrdsol.common.constants import CompScalerMeans, CompScalerStds
from xrdsol.common.data_utils import StandardScaler, chemical_symbols
from xrdsol.pl_data.dataset import TensorCrystDataset
from xrdsol.pl_data.datamodule import worker_init_fn
...
def get_model_path(eval_model_name):
    import xrdsol
    model_path = (
        Path(xrdsol.__file__).parent / 'prop_models' / eval_model_name)
    return model_path
